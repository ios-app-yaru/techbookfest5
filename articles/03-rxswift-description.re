...
プロジェクトメンバーが全員RxSwiftを書けるわけではないのにもかかわらず、とりあえずRxSwiftを使えば開発速度が早くなるんでしょ？という考え方で安易に導入すると逆に開発速度が落ちる可能性があります。
...
さきほどのaddTargetのパターンとまったく同じ動作をします。
